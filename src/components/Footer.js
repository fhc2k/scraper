      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mt-6 pt-4 border-t border-white/5">
          <p className="text-[10px] text-gray-700 text-center leading-relaxed max-w-3xl mx-auto">
            Los Comprobantes Electrónicos de Pago se generan con base en la información proporcionada 
            por las entidades receptoras de los pagos bajo su responsabilidad exclusiva. 
            Esta herramienta es un facilitador de consulta y no sustituye la verificación oficial.
          </p>
        </div>
      </div>
    </footer>
